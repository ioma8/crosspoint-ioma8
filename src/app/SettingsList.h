...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::String(StrId::STR_OPDS_SERVER_URL, &CrossPointSettings::opdsServerUrl, "opdsServerUrl",
                          StrId::STR_OPDS_BROWSER),
      SettingInfo::String(StrId::STR_USERNAME, &CrossPointSettings::opdsUsername, "opdsUsername",
                          StrId::STR_OPDS_BROWSER),
      SettingInfo::String(StrId::STR_PASSWORD, &CrossPointSettings::opdsPassword, "opdsPassword",
                          StrId::STR_OPDS_BROWSER)
          .withObfuscated(),
